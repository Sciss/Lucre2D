...
//
//object NAryOp extends ProductReader[NAryOp[_, _, _, _, _, _]] {
...
//    override def productPrefix = s"NAryOp$$$name"
//
//    def name: String
//
...
//  }
//
//  private[lucre] final class Expanded[T <: Exec[T], A1, A2, A3, A4, A5, A](op: NAryOp.Op[A1, A2, A3, A4, A5, A],
...
//    e.changed.--->(this)(tx0)
//
//    override def toString: String = s"NAryOp($op, $a, $b, $c, $d, $e)"
//
...
//  }
//
//  override def read(in: RefMapIn, key: String, arity: Int, adj: Int): NAryOp[_, _, _, _, _, _] = {
...
//    new NAryOp(_op, _a, _b, _c, _d, _e)
//  }
//}
//final case class NAryOp[A1, A2, A3, A4, A5, A](op: NAryOp.Op[A1, A2, A3, A4, A5, A],
...
//    val dx = d.expand[T]
//    val ex = e.expand[T]
//    new NAryOp.Expanded[T, A1, A2, A3, A4, A5, A](op, ax, bx, cx, dx, ex, tx)
//  }
//}
