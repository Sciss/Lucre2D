...
// This is an adapted Scala translation of the ParseException Java class of Apache Batik
...
class ParseException(message: String) extends RuntimeException(message) {
   ...
   */
  def this(message: String, line: Int, column: Int) = {
    this(message)
    exception     = null
    lineNumber    = line
    columnNumber  = column
