...
// This is an adapted Scala translation of the DefaultErrorHandler Java class of Apache Batik
 ...
 * @version $Id: DefaultErrorHandler.java 1733416 2016-03-03 07:07:13Z gadams $
 */
class DefaultErrorHandler extends ErrorHandler {
  ...
  override def error(e: ParseException): Unit = {
    throw e
  }
}
